...
import { authenticateUser, createUserDocument, getAllUserDocument, getUserDocumentById, refreshTokenUser} from '../services/user.services';
...
export class UserRouter {
  ...
  async createNewUser(req:Request, res:Response) {
      ...
      const user: UserDocument = await createUserDocument(req.body);
      if (user === null) {
